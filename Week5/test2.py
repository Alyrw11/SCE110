...
##Creativity3: In the remove part I made it so the input can be either the number or the
...
while while_shopping:
    ...
    if menu_select == "1" or menu_select == "add item":
        ...
        if shoppping_carts:
            ...
            for index in range(len(shoppping_carts)):
                if remove_item == shoppping_carts[index] or remove_item == str(index + 1):
