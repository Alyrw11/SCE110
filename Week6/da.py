#Creativity 1: The question is asked if they want to check another year if they choose NO the program ends. If YES the program continues. Use break to control the flow of the program.
#Creativity 2: Using lambdas to simplify the code 
